...
#          containing the Global Active Power in kilowatts for the 
#          effective dates of Feb 1st and 2nd of 2007.
#
...
#
# output: PNG file containing the histogram of the Global Active Power in kilowatts
#         named "plot1.png" in the current working directory.
#
